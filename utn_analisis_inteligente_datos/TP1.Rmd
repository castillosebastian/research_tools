...
```{r}
datos %>% group_by(juez, candidatos) %>% summarise(promedio = round(mean(valores), digits = 2)) %>% 
...
# traza = sum(diagonal matriz cuadrada). En el caso de la matriz de var-covar
# la traza daría por resultado la suma de las varianzas y por lo tanto una idea 
# de la magnitud del problema a explicar
